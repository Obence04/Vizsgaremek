...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Már 08. 09:40
...
(1, 'geco', '$12nhjbufdgsdf', 'admin@admin.admin', 620134567, 6),
(2, 'geco Jr.', '$12nhjbufdsgsdf', 'no@admin.zsido', 120134567, 1),
(3, 'geco Sr.', '$16nhjbufdsgsdf', 'yes@admin.zsido', 120134566, 2),
(4, 'jozsef.marton.k', '$12gusibfyig546jmhnßgíéfdhgfshdh', 'jozsef.marton@gemel.ru', NULL, 2),
(10, '12345678912', '0001-01-01', 'Fasz', NULL, 1),
(12, '72123456789', '2000-01-01', 'garon123@gmail.com', NULL, 1);
...
--
ALTER TABLE `felhasznalok`
  ADD CONSTRAINT `fk_felhasznalok_jogok1` FOREIGN KEY (`jog_id`) REFERENCES `jogok` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `orarend`
  ADD CONSTRAINT `orarend_ibfk_1` FOREIGN KEY (`osztaly_id`) REFERENCES `osztalyok` (`osztaly_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Megkötések a táblához `orarend-tanitott`
--
ALTER TABLE `orarend-tanitott`
  ADD CONSTRAINT `fk_orarend-tanitott_kapcs_tantargyak-tanitott_kapcs1` FOREIGN KEY (`tantargyak-tanitott_kapcs_id`) REFERENCES `tanitott-tantargyak` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_orarend_has_tanitott_tantargyak_orarend1` FOREIGN KEY (`orarend_id`) REFERENCES `orarend` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Megkötések a táblához `osztalyok`
--
ALTER TABLE `osztalyok`
  ADD CONSTRAINT `fk_osztalyok_tanarok` FOREIGN KEY (`osztalyfonok_id`) REFERENCES `tanarok` (`tanar_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Megkötések a táblához `tanarok`
--
ALTER TABLE `tanarok`
  ADD CONSTRAINT `fk_tanarok_felhasznalok1` FOREIGN KEY (`felhasznalo_id`) REFERENCES `felhasznalok` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Megkötések a táblához `tanitott-tantargyak`
--
ALTER TABLE `tanitott-tantargyak`
  ADD CONSTRAINT `fk_tantargyak-tanitott_kapcs_tanarok1` FOREIGN KEY (`tanarok_tanar_id`) REFERENCES `tanarok` (`tanar_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_tantargyak_has_tanitott_tantargyak_tantargyak1` FOREIGN KEY (`tantargyak_tantargy_id`) REFERENCES `tantargyak` (`tantargy_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
